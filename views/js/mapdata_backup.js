angular.module('mapdata', []).factory('mapdata', function($http){
    ...
    var convertToMapPoints = function(response){
        ...
        .success(function(results) {
            ...
            for(var i= 0; i < disasterSummary.length; i++) {
                ...
                .finally(function(){
                    console.log("Finally finished getting coordinates");
                    var  contentString =
                    ...
                    locations.push({
                        latlon: new google.maps.LatLng(LatLng[0], LatLng[1]),
                    ...
                    console.log("Just after processing");
                    console.log(locations);
    ...
    // Initializes the map
    var initialize = function(latitude, longitude, places) {
